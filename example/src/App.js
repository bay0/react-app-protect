...
const App = () => {
  return (
    <Protect password="test" blur={true}>
      <div>
        <div className="is-preload">
          <header id="header">
            <div className="content">
              <h1><a href="https://github.com/bay0/react-app-protect">Fractal</a></h1>
              <p>Just a simple, single page responsive<br />
              template brought to you by <a href="http://html5up.net">HTML5 UP</a></p>
              <ul className="actions">
                <li><a href="https://github.com/bay0/react-app-protect" className="button primary icon solid fa-download">Download</a></li>
                <li><a href="#one" className="button icon solid fa-chevron-down scrolly">Learn More</a></li>
              </ul>
            </div>
            <div className="image phone"><div className="inner"><img src={Screen} alt="" /></div></div>
          </header>
          ...
          <section id="three" className="wrapper style2 special">
            ...
            <ul className="actions special">
              <li><a href="https://github.com/bay0/react-app-protect" className="button primary icon solid fa-download">Download</a></li>
              <li><a href="https://github.com/bay0/react-app-protect" className="button">Learn More</a></li>
            </ul>
          </section>
          <footer id="footer">
            <ul className="icons">
              <li><a href="https://github.com/bay0/react-app-protect" className="icon brands fa-facebook-f"><span className="label">Facebook</span></a></li>
              <li><a href="https://github.com/bay0/react-app-protect" className="icon brands fa-twitter"><span className="label">Twitter</span></a></li>
              <li><a href="https://github.com/bay0/react-app-protect" className="icon brands fa-instagram"><span className="label">Instagram</span></a></li>
            </ul>
            <p className="copyright">&copy; bay0. Credits: <a href="http://html5up.net">HTML5 UP</a></p>
          </footer>
        </div>
      </div>
    </Protect>
